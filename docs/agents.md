...
| **vibecoding‑vue‑dev** | Antigravity | Vue 3 + Tailwind + shadcn-vue pages for VibeCoding | `.claude/agents/vibecoding-vue-dev.py` | `agents/vscode/vibecoding-vue-dev.py` |
...
| **vibecoding‑code‑reviewer** | Claude Code | PR review, quality gates for VibeCoding | `.claude/agents/vibecoding-code-reviewer.py` | `agents/vscode/vibecoding-code-reviewer.py` |
