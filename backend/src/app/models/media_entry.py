...
class MediaEntry(SQLModel, table=True):
    ...
    media_type: MediaType = Field(nullable=False, sa_type=String(50))
    format: Optional[MediaFormat] = Field(default=None, sa_type=String(50))
    status: MediaStatus = Field(default=MediaStatus.not_yet_released, sa_type=String(50))
    ...
    season: Optional[Season] = Field(default=None, sa_type=String(50))
