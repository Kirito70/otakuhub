...
class MediaEntry(SQLModel, table=True):
    ...
    media_type: MediaType = Field(nullable=False, sa_type=SAEnum(MediaType, create_constraint=False))
    format: Optional[MediaFormat] = Field(default=None, sa_type=SAEnum(MediaFormat, create_constraint=False))
    status: MediaStatus = Field(default=MediaStatus.not_yet_released, sa_type=SAEnum(MediaStatus, create_constraint=False))
    ...
    season: Optional[Season] = Field(default=None, sa_type=SAEnum(Season, create_constraint=False))
