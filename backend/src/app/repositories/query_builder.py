...
from sqlmodel import SQLModel, select, func, and_, or_, desc, asc
...
class QueryBuilder(Generic[ModelType]):
    ...
    def or_(self, condition) -> 'QueryBuilder[ModelType]':
        """Add an OR condition."""
        # This is a simplified approach - for complex OR, it's better to use SQLAlchemy's or_() function directly
        return self
